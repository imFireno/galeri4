    ...
    <div class="flex justify-center ml-[100px] mt-[300px]">
        ...
        <button data-modal-target="crud-modal" data-modal-toggle="crud-modal"
            ...
            <div class="flex flex-col justify-center">
                <svg class="w-[47px] h-[47px] text-center ml-4 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
        ...
        <div id="crud-modal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <!-- Modal body -->
                    <form class="p-4 md:p-5" method="post" action="/createalbum" enctype="multipart/form-data">
                        @csrf
                        <div class="col-span-2 sm:col-span-1">
                            ...
                            <div class="col-span-2 sm:col-span-1">
                                ...
                                <input type="text" name="nama_album" id="title"
